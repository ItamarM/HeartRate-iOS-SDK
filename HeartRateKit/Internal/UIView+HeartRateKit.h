 ...
 */
typedef NS_OPTIONS(NSUInteger, HRKViewPinEdges)
{
    /// Pins the top edge of an item.
    HRKViewPinTopEdge = 1 << 0,
   
    /// Pins the right edge of an item.
    HRKViewPinRightEdge = 1 << 1,

    /// Pins the bottom edge of an item.
    HRKViewPinBottomEdge = 1 << 2,
    
    /// Pins the left edge of an item.
    HRKViewPinLeftEdge = 1 << 3,
    
    /// Pins all edges of an item.
    HRKViewPinAllEdges = ~0UL
};
 ...
 *
 *  @param width The width to constrain the receiver to 
 *  @param relation The relation to constrain the receiver to
 *
 *  @return The `NSLayoutConstraint` generated by this method.
 */
 ...
 *  @return The `NSLayoutConstraint` generated by this method.
 */
-(NSLayoutConstraint *)hrkPinAttribute:(NSLayoutAttribute)attribute toSameAttributeOfView:(UIView *)peerView DEPRECATED_MSG_ATTRIBUTE("use pinAttribute:toSameAttributeOfItem: instead");
 ...
 *  @return The `NSLayoutConstraint` generated by this method.
 */
-(NSLayoutConstraint *)hrkPinEdge:(NSLayoutAttribute)edge toEdge:(NSLayoutAttribute)toEdge ofView:(UIView*)peerView DEPRECATED_MSG_ATTRIBUTE("use pinAttribute:toAttribute:ofItem: instead");
 ...
 *  @return The `NSLayoutConstraint` generated by this method.
 */
-(NSLayoutConstraint *)hrkPinEdge:(NSLayoutAttribute)edge toEdge:(NSLayoutAttribute)toEdge ofView:(UIView *)peerView inset:(CGFloat)inset DEPRECATED_MSG_ATTRIBUTE("use pinAttribute:toAttribute:ofItem:withConstant: instead");
 ...
 *  @return The `NSLayoutConstraint` generated by this method.
 */
-(NSLayoutConstraint *)hrkPinEdge:(NSLayoutAttribute)edge toEdge:(NSLayoutAttribute)toEdge ofItem:(id)peerItem DEPRECATED_MSG_ATTRIBUTE("use pinAttribute:toAttribute:ofItem instead");
 ...
 *  @return The `NSLayoutConstraint` generated by this method.
 */
-(NSLayoutConstraint *)hrkPinEdge:(NSLayoutAttribute)edge toEdge:(NSLayoutAttribute)toEdge ofItem:(id)peerItem inset:(CGFloat)inset DEPRECATED_MSG_ATTRIBUTE("use pinAttribute:toAttribute:ofItem:withConstant: instead");
 ...
 *  @return The `NSLayoutConstraint` generated by this method.
 */
-(NSLayoutConstraint *)hrkPinEdge:(NSLayoutAttribute)edge toEdge:(NSLayoutAttribute)toEdge ofItem:(id)peerItem inset:(CGFloat)inset relation:(NSLayoutRelation)relation DEPRECATED_MSG_ATTRIBUTE("use pinAttribute:toAttribute:ofItem:withConstant:relation: instead");
